...
## Report bugs using Github's [issues](https://github.com/LiquidatorCoder/among_us_app/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/LiquidatorCoder/among_us_app/issues/new); it's that easy!
